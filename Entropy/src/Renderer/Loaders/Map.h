...
public:
	...
	void load_entity_model_into_scene(TagHash sem, glm::quat rot, glm::vec4 pos, std::vector<Unk_808072C5> tech_maps, std::vector<TagHash> ext_techs, std::optional<Aabb> Occlusion_Bounds);
